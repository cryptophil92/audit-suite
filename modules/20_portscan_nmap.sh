...
MOD_CAPABILITIES=("tcp_port_scan" "service_detection" "udp_port_scan" "os_detection")
MOD_INTRUSIVENESS="high"
MOD_PRIVILEGES=("standard_user" "raw_socket_optional")
MOD_SELECTABLE=1
MOD_LIMITATIONS="La couverture varie selon le profil, les filtres réseau et les privilèges ; sans sockets brutes, OS et UDP sont omis."
